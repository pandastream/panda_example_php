...
a.unescapeFilePostParams=function(b){var c=/[$]([0-9a-f]{4})/i,d={},g;if(b!=undefined){for(var f in b.post)if(b.post.hasOwnProperty(f)){g=f;for(var e;(e=c.exec(g))!==null;)g=g.replace(e[0],String.fromCharCode(parseInt("0x"+e[1],16)));d[g]=b.post[f]}b.post=d}return b};a.testExternalInterface=function(){try{return this.callFlash("TestExternalInterface")}catch(b){return false}};a.flashReady=function(){var b=this.getMovieElement();if(b){this.cleanUp(b);this.queueEvent("swfupload_loaded_handler")}else this.debug("Flash called back ready but the flash movie can't be found.")};
a.cleanUp=function(b){try{if(this.movieElement&&typeof b.CallFunction==="unknown"){this.debug("Removing Flash functions hooks (this should only run in IE and should prevent memory leaks)");for(var c in b)try{if(typeof b[c]==="function")b[c]=null}catch(d){}}}catch(g){}window.__flash__removeCallback=function(f,e){try{if(f)f[e]=null}catch(h){}}};a.fileDialogStart=function(){this.queueEvent("file_dialog_start_handler")};
...
(function(b){var c=["swfupload_loaded_handler","file_queued_handler","file_queue_error_handler","file_dialog_start_handler","file_dialog_complete_handler","upload_start_handler","upload_progress_handler","upload_error_handler","upload_success_handler","upload_complete_handler","queue_complete_handler"],d=[];b.fn.swfupload=function(){var g=b.makeArray(arguments);return this.each(function(){var f;if(g.length==1&&typeof g[0]=="object"){f=b(this).data("__swfu");if(!f){var e=g[0],h=b(this);f=[];b.merge(f,
c);b.merge(f,d);b.each(f,function(t,m){var r=m.replace(/_handler$/,"").replace(/_([a-z])/g,function(l,q){return q.toUpperCase()});e[m]=function(){var l=b.Event(r);h.trigger(l,b.makeArray(arguments));return!l.isDefaultPrevented()}});b(this).data("__swfu",new SWFUpload(e))}}else if(g.length>0&&typeof g[0]=="string"){var n=g.shift();(f=b(this).data("__swfu"))&&f[n]&&f[n].apply(f,g)}})};b.swfupload={additionalHandlers:function(){if(arguments.length===0)return d.slice();else b(arguments).each(function(g,
f){b.merge(d,b.makeArray(f))})},defaultHandlers:function(){return c.slice()},getInstance:function(g){return b(g).data("__swfu")}}})(jQuery);
(function(){function b(f){this.options=f}var c=0,d=0,g=0;jQuery.fn.pandaUploader=function(f,e,h){function n(){o.closest("form").submit(m)}function t(i,k){c++;d++;i=$("#"+e.upload_filename_id);i.size()!=0&&i.val(k.name)}function m(){j.swfupload("startUpload");return false}function r(i,k){e.progress_handler&&e.progress_handler.start(k)}function l(i,k,p,s){try{e.progress_handler&&e.progress_handler.setProgress(k,p,s)}catch(w){}}function q(i,k,p){o.val(eval("("+p+")").id);d--}function u(i,k,p,s){alert("There was an error uploading the file.\n\nHTTP error code "+
s);d--;g++}function v(){if(!(d>0&&c!=g||c==g))if(o.val()){var i=o.closest("form")[0];document.createElement("FORM").submit.apply(i)}else alert("The video ID was not stored on the form")}if(f===undefined){alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}e=e===undefined?{}:e;h=h===undefined?{}:h;if(e.upload_button_id===undefined){alert("You have to specify the button id");return false}e=jQuery.extend({upload_filename_id:null,upload_progress_id:null,
api_url:"http://api.pandastream.com/v2",progress_handler:null,uploader_dir:"/panda_uploader"},e);if(!e.progress_handler)e.progress_handler=new b(e);var j=this.swfupload(jQuery.extend({upload_url:e.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:e.uploader_dir+"/swfupload.swf",button_image_url:e.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:e.upload_button_id,post_params:f,file_post_name:"file",
debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(f){var e=jQuery("#"+this.options.upload_progress_id);if(e.size()!=0){e.find(".progress-inside").size()==0&&e.append('<div class="progress-inside"><span>Uploading...</span></div>');this.progress=e.find(".progress-inside");this.setProgress(f,0,f.size)}},setProgress:function(f,
e,h){if(this.progress){f=Math.ceil(e/h*100);$(this.progress).css("width",f+"%")}}}})();
var a,SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};SWFUpload.prototype.initSWFUpload=function(b){try{this.customSettings={};this.settings=b;this.eventQueue=[];this.movieName="SWFUpload_"+SWFUpload.movieCount++;this.movieElement=null;SWFUpload.instances[this.movieName]=this;this.initSettings();this.loadFlash();this.displayDebugInfo()}catch(c){delete SWFUpload.instances[this.movieName];throw c;}};SWFUpload.instances={};SWFUpload.movieCount=0;SWFUpload.version="2.2.0 2009-03-25";
SWFUpload.QUEUE_ERROR={QUEUE_LIMIT_EXCEEDED:-100,FILE_EXCEEDS_SIZE_LIMIT:-110,ZERO_BYTE_FILE:-120,INVALID_FILETYPE:-130};SWFUpload.UPLOAD_ERROR={HTTP_ERROR:-200,MISSING_UPLOAD_URL:-210,IO_ERROR:-220,SECURITY_ERROR:-230,UPLOAD_LIMIT_EXCEEDED:-240,UPLOAD_FAILED:-250,SPECIFIED_FILE_ID_NOT_FOUND:-260,FILE_VALIDATION_FAILED:-270,FILE_CANCELLED:-280,UPLOAD_STOPPED:-290};SWFUpload.FILE_STATUS={QUEUED:-1,IN_PROGRESS:-2,ERROR:-3,COMPLETE:-4,CANCELLED:-5};
SWFUpload.BUTTON_ACTION={SELECT_FILE:-100,SELECT_FILES:-110,START_UPLOAD:-120};SWFUpload.CURSOR={ARROW:-1,HAND:-2};SWFUpload.WINDOW_MODE={WINDOW:"window",TRANSPARENT:"transparent",OPAQUE:"opaque"};SWFUpload.completeURL=function(b){if(typeof b!=="string"||b.match(/^https?:\/\//i)||b.match(/^\//))return b;var c=window.location.pathname.lastIndexOf("/");path=c<=0?"/":window.location.pathname.substr(0,c)+"/";return path+b};a=SWFUpload.prototype;
a.initSettings=function(){this.ensureDefault=function(b,c){this.settings[b]=this.settings[b]==undefined?c:this.settings[b]};this.ensureDefault("upload_url","");this.ensureDefault("preserve_relative_urls",false);this.ensureDefault("file_post_name","Filedata");this.ensureDefault("post_params",{});this.ensureDefault("use_query_string",false);this.ensureDefault("requeue_on_error",false);this.ensureDefault("http_success",[]);this.ensureDefault("assume_success_timeout",0);this.ensureDefault("file_types",
...
s);d--;g++}function v(){if(!(d>0&&c!=g||c==g))if(o.val()){var i=o.closest("form")[0];document.createElement("FORM").submit.apply(i)}else alert("The video ID was not stored on the form")}if(f===undefined){alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}e=e===undefined?{}:e;h=h===undefined?{}:h;if(e.upload_button_id===undefined){alert("You have to specify the button id");return false}e=jQuery.extend({upload_filename_id:null,upload_progress_id:null,
api_url:"http://api.pandastream.com/v2",progress_handler:null,uploader_dir:"/panda_uploader"},e);if(!e.progress_handler)e.progress_handler=new b(e);var j=this.swfupload(jQuery.extend({upload_url:e.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:e.uploader_dir+"/swfupload.swf",button_image_url:e.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:e.upload_button_id,post_params:f,file_post_name:"file",
debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(f){var e=jQuery("#"+this.options.upload_progress_id);if(e.size()!=0){e.find(".progress-inside").size()==0&&e.append('<div class="progress-inside"><span>Uploading...</span></div>');this.progress=e.find(".progress-inside");this.setProgress(f,0,f.size);e.show()}},
setProgress:function(f,e,h){if(this.progress){f=Math.ceil(e/h*100);$(this.progress).css("width",f+"%")}}}})();
var a,SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};SWFUpload.prototype.initSWFUpload=function(b){try{this.customSettings={};this.settings=b;this.eventQueue=[];this.movieName="SWFUpload_"+SWFUpload.movieCount++;this.movieElement=null;SWFUpload.instances[this.movieName]=this;this.initSettings();this.loadFlash();this.displayDebugInfo()}catch(c){delete SWFUpload.instances[this.movieName];throw c;}};SWFUpload.instances={};SWFUpload.movieCount=0;SWFUpload.version="2.2.0 2009-03-25";
SWFUpload.QUEUE_ERROR={QUEUE_LIMIT_EXCEEDED:-100,FILE_EXCEEDS_SIZE_LIMIT:-110,ZERO_BYTE_FILE:-120,INVALID_FILETYPE:-130};SWFUpload.UPLOAD_ERROR={HTTP_ERROR:-200,MISSING_UPLOAD_URL:-210,IO_ERROR:-220,SECURITY_ERROR:-230,UPLOAD_LIMIT_EXCEEDED:-240,UPLOAD_FAILED:-250,SPECIFIED_FILE_ID_NOT_FOUND:-260,FILE_VALIDATION_FAILED:-270,FILE_CANCELLED:-280,UPLOAD_STOPPED:-290};SWFUpload.FILE_STATUS={QUEUED:-1,IN_PROGRESS:-2,ERROR:-3,COMPLETE:-4,CANCELLED:-5};
SWFUpload.BUTTON_ACTION={SELECT_FILE:-100,SELECT_FILES:-110,START_UPLOAD:-120};SWFUpload.CURSOR={ARROW:-1,HAND:-2};SWFUpload.WINDOW_MODE={WINDOW:"window",TRANSPARENT:"transparent",OPAQUE:"opaque"};SWFUpload.completeURL=function(b){if(typeof b!=="string"||b.match(/^https?:\/\//i)||b.match(/^\//))return b;var c=window.location.pathname.lastIndexOf("/");path=c<=0?"/":window.location.pathname.substr(0,c)+"/";return path+b};a=SWFUpload.prototype;
a.initSettings=function(){this.ensureDefault=function(b,c){this.settings[b]=this.settings[b]==undefined?c:this.settings[b]};this.ensureDefault("upload_url","");this.ensureDefault("preserve_relative_urls",false);this.ensureDefault("file_post_name","Filedata");this.ensureDefault("post_params",{});this.ensureDefault("use_query_string",false);this.ensureDefault("requeue_on_error",false);this.ensureDefault("http_success",[]);this.ensureDefault("assume_success_timeout",0);this.ensureDefault("file_types",
...
s);d--;g++}function v(){if(!(d>0&&c!=g||c==g))if(o.val()){var i=o.closest("form")[0];document.createElement("FORM").submit.apply(i)}else alert("The video ID was not stored on the form")}if(f===undefined){alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}e=e===undefined?{}:e;h=h===undefined?{}:h;if(e.upload_button_id===undefined){alert("You have to specify the button id");return false}e=jQuery.extend({upload_filename_id:null,upload_progress_id:null,
api_url:"http://api.pandastream.com/v2",progress_handler:null,uploader_dir:"/panda_uploader"},e);if(!e.progress_handler)e.progress_handler=new b(e);var j=this.swfupload(jQuery.extend({upload_url:e.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:e.uploader_dir+"/swfupload.swf",button_image_url:e.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:e.upload_button_id,post_params:f,file_post_name:"file",
debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(f){var e=jQuery("#"+this.options.upload_progress_id);if(e.size()!=0){e.find(".progress-inside").size()==0&&e.append('<div class="progress-inside"></div>');this.progress=e.find(".progress-inside");this.setProgress(f,0,f.size);e.show()}},setProgress:function(f,e,
h){if(this.progress){f=Math.ceil(e/h*100);$(this.progress).css("width",f+"%")}}}})();
var a,SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};SWFUpload.prototype.initSWFUpload=function(b){try{this.customSettings={};this.settings=b;this.eventQueue=[];this.movieName="SWFUpload_"+SWFUpload.movieCount++;this.movieElement=null;SWFUpload.instances[this.movieName]=this;this.initSettings();this.loadFlash();this.displayDebugInfo()}catch(c){delete SWFUpload.instances[this.movieName];throw c;}};SWFUpload.instances={};SWFUpload.movieCount=0;SWFUpload.version="2.2.0 2009-03-25";
SWFUpload.QUEUE_ERROR={QUEUE_LIMIT_EXCEEDED:-100,FILE_EXCEEDS_SIZE_LIMIT:-110,ZERO_BYTE_FILE:-120,INVALID_FILETYPE:-130};SWFUpload.UPLOAD_ERROR={HTTP_ERROR:-200,MISSING_UPLOAD_URL:-210,IO_ERROR:-220,SECURITY_ERROR:-230,UPLOAD_LIMIT_EXCEEDED:-240,UPLOAD_FAILED:-250,SPECIFIED_FILE_ID_NOT_FOUND:-260,FILE_VALIDATION_FAILED:-270,FILE_CANCELLED:-280,UPLOAD_STOPPED:-290};SWFUpload.FILE_STATUS={QUEUED:-1,IN_PROGRESS:-2,ERROR:-3,COMPLETE:-4,CANCELLED:-5};
SWFUpload.BUTTON_ACTION={SELECT_FILE:-100,SELECT_FILES:-110,START_UPLOAD:-120};SWFUpload.CURSOR={ARROW:-1,HAND:-2};SWFUpload.WINDOW_MODE={WINDOW:"window",TRANSPARENT:"transparent",OPAQUE:"opaque"};SWFUpload.completeURL=function(b){if(typeof b!=="string"||b.match(/^https?:\/\//i)||b.match(/^\//))return b;var c=window.location.pathname.lastIndexOf("/");path=c<=0?"/":window.location.pathname.substr(0,c)+"/";return path+b};a=SWFUpload.prototype;
a.initSettings=function(){this.ensureDefault=function(b,c){this.settings[b]=this.settings[b]==undefined?c:this.settings[b]};this.ensureDefault("upload_url","");this.ensureDefault("preserve_relative_urls",false);this.ensureDefault("file_post_name","Filedata");this.ensureDefault("post_params",{});this.ensureDefault("use_query_string",false);this.ensureDefault("requeue_on_error",false);this.ensureDefault("http_success",[]);this.ensureDefault("assume_success_timeout",0);this.ensureDefault("file_types",
...
f){b.merge(d,b.makeArray(f))})},defaultHandlers:function(){return c.slice()},getInstance:function(g){return b(g).data("__swfu")}}})(jQuery);
(function(){function b(f){this.options=f}var c=0,d=0,g=0;jQuery.fn.pandaUploader=function(f,e,h){function n(){o.closest("form").submit(m)}function t(i,k){c++;d++;i=$("#"+e.upload_filename_id);i.size()!=0&&i.val(k.name)}function m(){j.swfupload("startUpload");return false}function r(i,k){e.progress_handler&&e.progress_handler.start(k)}function l(i,k,p,s){try{e.progress_handler&&e.progress_handler.setProgress(k,p,s)}catch(w){}}function q(i,k,p){o.val(eval("("+p+")").id);d--}function u(i,k,p,s){alert("There was an error uploading the file.\n\nHTTP error code "+
s);d--;g++}function v(){if(!(d>0&&c!=g||c==g))if(o.val()){var i=o.closest("form")[0];document.createElement("FORM").submit.apply(i)}else alert("The video ID was not stored on the form")}if(f===undefined){alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}e=e===undefined?{}:e;h=h===undefined?{}:h;if(e.upload_button_id===undefined){alert("You have to specify the button id");return false}if($(this).size()==0){alert("The jQuery element is empty. Method pandaUploader() cannot be executed");
return false}e=jQuery.extend({upload_filename_id:null,upload_progress_id:null,api_url:"http://api.pandastream.com/v2",progress_handler:null,uploader_dir:"/panda_uploader"},e);if(!e.progress_handler)e.progress_handler=new b(e);var j=this.swfupload(jQuery.extend({upload_url:e.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:e.uploader_dir+"/swfupload.swf",button_image_url:e.uploader_dir+"/choose_file_button.png",button_width:87,
button_height:27,button_placeholder_id:e.upload_button_id,post_params:f,file_post_name:"file",debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(f){var e=jQuery("#"+this.options.upload_progress_id);if(e.size()!=0){e.find(".progress-inside").size()==0&&e.append('<div class="progress-inside"></div>');this.progress=
e.find(".progress-inside");this.setProgress(f,0,f.size);e.show()}},setProgress:function(f,e,h){if(this.progress){f=Math.ceil(e/h*100);$(this.progress).css("width",f+"%")}}}})();
var a,SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};SWFUpload.prototype.initSWFUpload=function(b){try{this.customSettings={};this.settings=b;this.eventQueue=[];this.movieName="SWFUpload_"+SWFUpload.movieCount++;this.movieElement=null;SWFUpload.instances[this.movieName]=this;this.initSettings();this.loadFlash();this.displayDebugInfo()}catch(c){delete SWFUpload.instances[this.movieName];throw c;}};SWFUpload.instances={};SWFUpload.movieCount=0;SWFUpload.version="2.2.0 2009-03-25";
SWFUpload.QUEUE_ERROR={QUEUE_LIMIT_EXCEEDED:-100,FILE_EXCEEDS_SIZE_LIMIT:-110,ZERO_BYTE_FILE:-120,INVALID_FILETYPE:-130};SWFUpload.UPLOAD_ERROR={HTTP_ERROR:-200,MISSING_UPLOAD_URL:-210,IO_ERROR:-220,SECURITY_ERROR:-230,UPLOAD_LIMIT_EXCEEDED:-240,UPLOAD_FAILED:-250,SPECIFIED_FILE_ID_NOT_FOUND:-260,FILE_VALIDATION_FAILED:-270,FILE_CANCELLED:-280,UPLOAD_STOPPED:-290};SWFUpload.FILE_STATUS={QUEUED:-1,IN_PROGRESS:-2,ERROR:-3,COMPLETE:-4,CANCELLED:-5};
SWFUpload.BUTTON_ACTION={SELECT_FILE:-100,SELECT_FILES:-110,START_UPLOAD:-120};SWFUpload.CURSOR={ARROW:-1,HAND:-2};SWFUpload.WINDOW_MODE={WINDOW:"window",TRANSPARENT:"transparent",OPAQUE:"opaque"};SWFUpload.completeURL=function(b){if(typeof b!=="string"||b.match(/^https?:\/\//i)||b.match(/^\//))return b;var c=window.location.pathname.lastIndexOf("/");path=c<=0?"/":window.location.pathname.substr(0,c)+"/";return path+b};a=SWFUpload.prototype;
a.initSettings=function(){this.ensureDefault=function(b,c){this.settings[b]=this.settings[b]==undefined?c:this.settings[b]};this.ensureDefault("upload_url","");this.ensureDefault("preserve_relative_urls",false);this.ensureDefault("file_post_name","Filedata");this.ensureDefault("post_params",{});this.ensureDefault("use_query_string",false);this.ensureDefault("requeue_on_error",false);this.ensureDefault("http_success",[]);this.ensureDefault("assume_success_timeout",0);this.ensureDefault("file_types",
...
"&amp;buttonAction=",encodeURIComponent(this.settings.button_action),"&amp;buttonDisabled=",encodeURIComponent(this.settings.button_disabled),"&amp;buttonCursor=",encodeURIComponent(this.settings.button_cursor)].join("")};a.getMovieElement=function(){if(this.movieElement==undefined)this.movieElement=document.getElementById(this.movieName);if(this.movieElement===null)throw"Could not find Flash element";return this.movieElement};
a.buildParamString=function(){var b=this.settings.post_params,c=[];if(typeof b==="object")for(var d in b)b.hasOwnProperty(d)&&c.push(encodeURIComponent(d.toString())+"="+encodeURIComponent(b[d].toString()));return c.join("&amp;")};
a.destroy=function(){try{this.cancelUpload(null,false);var b=null;if((b=this.getMovieElement())&&typeof b.CallFunction==="unknown"){for(var c in b)try{if(typeof b[c]==="function")b[c]=null}catch(d){}try{b.parentNode.removeChild(b)}catch(f){}}window[this.movieName]=null;SWFUpload.instances[this.movieName]=null;delete SWFUpload.instances[this.movieName];this.movieName=this.eventQueue=this.customSettings=this.settings=this.movieElement=null;return true}catch(e){return false}};
a.displayDebugInfo=function(){this.debug(["---SWFUpload Instance Info---\nVersion: ",SWFUpload.version,"\nMovie Name: ",this.movieName,"\nSettings:\n\tupload_url:               ",this.settings.upload_url,"\n\tflash_url:                ",this.settings.flash_url,"\n\tuse_query_string:         ",this.settings.use_query_string.toString(),"\n\trequeue_on_error:         ",this.settings.requeue_on_error.toString(),"\n\thttp_success:             ",this.settings.http_success.join(", "),"\n\tassume_success_timeout:   ",
this.settings.assume_success_timeout,"\n\tfile_post_name:           ",this.settings.file_post_name,"\n\tpost_params:              ",this.settings.post_params.toString(),"\n\tfile_types:               ",this.settings.file_types,"\n\tfile_types_description:   ",this.settings.file_types_description,"\n\tfile_size_limit:          ",this.settings.file_size_limit,"\n\tfile_upload_limit:        ",this.settings.file_upload_limit,"\n\tfile_queue_limit:         ",this.settings.file_queue_limit,"\n\tdebug:                    ",
this.settings.debug.toString(),"\n\tprevent_swf_caching:      ",this.settings.prevent_swf_caching.toString(),"\n\tbutton_placeholder_id:    ",this.settings.button_placeholder_id.toString(),"\n\tbutton_placeholder:       ",this.settings.button_placeholder?"Set":"Not Set","\n\tbutton_image_url:         ",this.settings.button_image_url.toString(),"\n\tbutton_width:             ",this.settings.button_width.toString(),"\n\tbutton_height:            ",this.settings.button_height.toString(),"\n\tbutton_text:              ",
this.settings.button_text.toString(),"\n\tbutton_text_style:        ",this.settings.button_text_style.toString(),"\n\tbutton_text_top_padding:  ",this.settings.button_text_top_padding.toString(),"\n\tbutton_text_left_padding: ",this.settings.button_text_left_padding.toString(),"\n\tbutton_action:            ",this.settings.button_action.toString(),"\n\tbutton_disabled:          ",this.settings.button_disabled.toString(),"\n\tcustom_settings:          ",this.settings.custom_settings.toString(),"\nEvent Handlers:\n\tswfupload_loaded_handler assigned:  ",
...
"function").toString(),"\n\tupload_progress_handler assigned:   ",(typeof this.settings.upload_progress_handler==="function").toString(),"\n\tupload_error_handler assigned:      ",(typeof this.settings.upload_error_handler==="function").toString(),"\n\tupload_success_handler assigned:    ",(typeof this.settings.upload_success_handler==="function").toString(),"\n\tupload_complete_handler assigned:   ",(typeof this.settings.upload_complete_handler==="function").toString(),"\n\tdebug_handler assigned:             ",
(typeof this.settings.debug_handler==="function").toString(),"\n"].join(""))};a.addSetting=function(b,c,d){return c==undefined?(this.settings[b]=d):(this.settings[b]=c)};a.getSetting=function(b){if(this.settings[b]!=undefined)return this.settings[b];return""};
a.callFlash=function(b,c){c=c||[];var d=this.getMovieElement(),f,e;try{e=d.CallFunction('<invoke name="'+b+'" returntype="javascript">'+__flash__argumentsToXML(c,0)+"</invoke>");f=eval(e)}catch(g){throw"Call to "+b+" failed";}if(f!=undefined&&typeof f.post==="object")f=this.unescapeFilePostParams(f);return f};a.selectFile=function(){this.callFlash("SelectFile")};a.selectFiles=function(){this.callFlash("SelectFiles")};a.startUpload=function(b){this.callFlash("StartUpload",[b])};
a.cancelUpload=function(b,c){if(c!==false)c=true;this.callFlash("CancelUpload",[b,c])};a.stopUpload=function(){this.callFlash("StopUpload")};a.getStats=function(){return this.callFlash("GetStats")};a.setStats=function(b){this.callFlash("SetStats",[b])};a.getFile=function(b){return typeof b==="number"?this.callFlash("GetFileByIndex",[b]):this.callFlash("GetFile",[b])};a.addFileParam=function(b,c,d){return this.callFlash("AddFileParam",[b,c,d])};
a.removeFileParam=function(b,c){this.callFlash("RemoveFileParam",[b,c])};a.setUploadURL=function(b){this.settings.upload_url=b.toString();this.callFlash("SetUploadURL",[b])};a.setPostParams=function(b){this.settings.post_params=b;this.callFlash("SetPostParams",[b])};a.addPostParam=function(b,c){this.settings.post_params[b]=c;this.callFlash("SetPostParams",[this.settings.post_params])};a.removePostParam=function(b){delete this.settings.post_params[b];this.callFlash("SetPostParams",[this.settings.post_params])};
a.setFileTypes=function(b,c){this.settings.file_types=b;this.settings.file_types_description=c;this.callFlash("SetFileTypes",[b,c])};a.setFileSizeLimit=function(b){this.settings.file_size_limit=b;this.callFlash("SetFileSizeLimit",[b])};a.setFileUploadLimit=function(b){this.settings.file_upload_limit=b;this.callFlash("SetFileUploadLimit",[b])};a.setFileQueueLimit=function(b){this.settings.file_queue_limit=b;this.callFlash("SetFileQueueLimit",[b])};
a.setFilePostName=function(b){this.settings.file_post_name=b;this.callFlash("SetFilePostName",[b])};a.setUseQueryString=function(b){this.settings.use_query_string=b;this.callFlash("SetUseQueryString",[b])};a.setRequeueOnError=function(b){this.settings.requeue_on_error=b;this.callFlash("SetRequeueOnError",[b])};a.setHTTPSuccess=function(b){if(typeof b==="string")b=b.replace(" ","").split(",");this.settings.http_success=b;this.callFlash("SetHTTPSuccess",[b])};
...
a.setButtonTextStyle=function(b){this.settings.button_text_style=b;this.callFlash("SetButtonTextStyle",[b])};a.setButtonDisabled=function(b){this.settings.button_disabled=b;this.callFlash("SetButtonDisabled",[b])};a.setButtonAction=function(b){this.settings.button_action=b;this.callFlash("SetButtonAction",[b])};a.setButtonCursor=function(b){this.settings.button_cursor=b;this.callFlash("SetButtonCursor",[b])};
a.queueEvent=function(b,c){if(c==undefined)c=[];else c instanceof Array||(c=[c]);var d=this;if(typeof this.settings[b]==="function"){this.eventQueue.push(function(){this.settings[b].apply(this,c)});setTimeout(function(){d.executeNextEvent()},0)}else if(this.settings[b]!==null)throw"Event handler "+b+" is unknown or is not a function";};a.executeNextEvent=function(){var b=this.eventQueue?this.eventQueue.shift():null;typeof b==="function"&&b.apply(this)};
a.unescapeFilePostParams=function(b){var c=/[$]([0-9a-f]{4})/i,d={},f;if(b!=undefined){for(var e in b.post)if(b.post.hasOwnProperty(e)){f=e;for(var g;(g=c.exec(f))!==null;)f=f.replace(g[0],String.fromCharCode(parseInt("0x"+g[1],16)));d[f]=b.post[e]}b.post=d}return b};a.testExternalInterface=function(){try{return this.callFlash("TestExternalInterface")}catch(b){return false}};a.flashReady=function(){var b=this.getMovieElement();if(b){this.cleanUp(b);this.queueEvent("swfupload_loaded_handler")}else this.debug("Flash called back ready but the flash movie can't be found.")};
a.cleanUp=function(b){try{if(this.movieElement&&typeof b.CallFunction==="unknown"){this.debug("Removing Flash functions hooks (this should only run in IE and should prevent memory leaks)");for(var c in b)try{if(typeof b[c]==="function")b[c]=null}catch(d){}}}catch(f){}window.__flash__removeCallback=function(e,g){try{if(e)e[g]=null}catch(h){}}};a.fileDialogStart=function(){this.queueEvent("file_dialog_start_handler")};
a.fileQueued=function(b){b=this.unescapeFilePostParams(b);this.queueEvent("file_queued_handler",b)};a.fileQueueError=function(b,c,d){b=this.unescapeFilePostParams(b);this.queueEvent("file_queue_error_handler",[b,c,d])};a.fileDialogComplete=function(b,c,d){this.queueEvent("file_dialog_complete_handler",[b,c,d])};a.uploadStart=function(b){b=this.unescapeFilePostParams(b);this.queueEvent("return_upload_start_handler",b)};
a.returnUploadStart=function(b){var c;if(typeof this.settings.upload_start_handler==="function"){b=this.unescapeFilePostParams(b);c=this.settings.upload_start_handler.call(this,b)}else if(this.settings.upload_start_handler!=undefined)throw"upload_start_handler must be a function";if(c===undefined)c=true;c=!!c;this.callFlash("ReturnUploadStart",[c])};a.uploadProgress=function(b,c,d){b=this.unescapeFilePostParams(b);this.queueEvent("upload_progress_handler",[b,c,d])};
a.uploadError=function(b,c,d){b=this.unescapeFilePostParams(b);this.queueEvent("upload_error_handler",[b,c,d])};a.uploadSuccess=function(b,c,d){b=this.unescapeFilePostParams(b);this.queueEvent("upload_success_handler",[b,c,d])};a.uploadComplete=function(b){b=this.unescapeFilePostParams(b);this.queueEvent("upload_complete_handler",b)};a.debug=function(b){this.queueEvent("debug_handler",b)};
a.debugMessage=function(b){if(this.settings.debug){var c=[];if(typeof b==="object"&&typeof b.name==="string"&&typeof b.message==="string"){for(var d in b)b.hasOwnProperty(d)&&c.push(d+": "+b[d]);b=c.join("\n")||"";c=b.split("\n");b="EXCEPTION: "+c.join("\nEXCEPTION: ");SWFUpload.Console.writeLine(b)}else SWFUpload.Console.writeLine(b)}};SWFUpload.Console={};
SWFUpload.Console.writeLine=function(b){var c,d;try{c=document.getElementById("SWFUpload_Console");if(!c){d=document.createElement("form");document.getElementsByTagName("body")[0].appendChild(d);c=document.createElement("textarea");c.id="SWFUpload_Console";c.style.fontFamily="monospace";c.setAttribute("wrap","off");c.wrap="off";c.style.overflow="auto";c.style.width="700px";c.style.height="350px";c.style.margin="5px";d.appendChild(c)}c.value+=b+"\n";c.scrollTop=c.scrollHeight-c.clientHeight}catch(f){alert("Exception: "+
f.name+" Message: "+f.message)}};
(function(b){var c=["swfupload_loaded_handler","file_queued_handler","file_queue_error_handler","file_dialog_start_handler","file_dialog_complete_handler","upload_start_handler","upload_progress_handler","upload_error_handler","upload_success_handler","upload_complete_handler","queue_complete_handler"],d=[];b.fn.swfupload=function(){var f=b.makeArray(arguments);return this.each(function(){var e;if(f.length==1&&typeof f[0]=="object"){e=b(this).data("__swfu");if(!e){var g=f[0],h=b(this);e=[];b.merge(e,
c);b.merge(e,d);b.each(e,function(t,m){var r=m.replace(/_handler$/,"").replace(/_([a-z])/g,function(l,q){return q.toUpperCase()});g[m]=function(){var l=b.Event(r);h.trigger(l,b.makeArray(arguments));return!l.isDefaultPrevented()}});b(this).data("__swfu",new SWFUpload(g))}}else if(f.length>0&&typeof f[0]=="string"){var n=f.shift();(e=b(this).data("__swfu"))&&e[n]&&e[n].apply(e,f)}})};b.swfupload={additionalHandlers:function(){if(arguments.length===0)return d.slice();else b(arguments).each(function(f,
e){b.merge(d,b.makeArray(e))})},defaultHandlers:function(){return c.slice()},getInstance:function(f){return b(f).data("__swfu")}}})(jQuery);
(function(){function b(e){this.options=e;this.$p=jQuery("#"+this.options.upload_progress_id);this.$p.hide()}var c=0,d=0,f=0;jQuery.fn.pandaUploader=function(e,g,h){function n(){o.closest("form").submit(m)}function t(i,k){c++;d++;i=$("#"+g.upload_filename_id);i.size()!=0&&i.val(k.name)}function m(){j.swfupload("startUpload");return false}function r(i,k){g.progress_handler&&g.progress_handler.start(k)}function l(i,k,p,s){try{g.progress_handler&&g.progress_handler.setProgress(k,p,s)}catch(w){}}function q(i,
k,p){o.val(eval("("+p+")").id);d--}function u(i,k,p,s){alert("There was an error uploading the file.\n\nHTTP error code "+s);d--;f++}function v(){if(!(d>0&&c!=f||c==f))if(o.val()){var i=o.closest("form")[0];document.createElement("FORM").submit.apply(i)}else alert("The video ID was not stored on the form")}if(e===undefined){alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}g=g===undefined?{}:g;h=h===undefined?{}:h;if(g.upload_button_id===
undefined){alert("You have to specify the button id");return false}if($(this).size()==0){alert("The jQuery element is empty. Method pandaUploader() cannot be executed");return false}g=jQuery.extend({upload_filename_id:null,upload_progress_id:null,api_url:"http://api.pandastream.com/v2",progress_handler:null,uploader_dir:"/panda_uploader"},g);if(!g.progress_handler)g.progress_handler=new b(g);var j=this.swfupload(jQuery.extend({upload_url:g.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",
file_types_description:"All Files",file_upload_limit:0,flash_url:g.uploader_dir+"/swfupload.swf",button_image_url:g.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:g.upload_button_id,post_params:e,file_post_name:"file",debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(e){if(this.$p.size()!=
0){this.$p.find(".progress-inside").size()==0&&this.$p.append('<div class="progress-inside"></div>');this.progress=this.$p.find(".progress-inside");this.setProgress(e,0,e.size)}},setProgress:function(e,g,h){if(this.progress){e=Math.ceil(g/h*100);$(this.progress).css("width",e+"%")}}}})();
var a,SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};SWFUpload.prototype.initSWFUpload=function(b){try{this.customSettings={};this.settings=b;this.eventQueue=[];this.movieName="SWFUpload_"+SWFUpload.movieCount++;this.movieElement=null;SWFUpload.instances[this.movieName]=this;this.initSettings();this.loadFlash();this.displayDebugInfo()}catch(c){delete SWFUpload.instances[this.movieName];throw c;}};SWFUpload.instances={};SWFUpload.movieCount=0;SWFUpload.version="2.2.0 2009-03-25";
SWFUpload.QUEUE_ERROR={QUEUE_LIMIT_EXCEEDED:-100,FILE_EXCEEDS_SIZE_LIMIT:-110,ZERO_BYTE_FILE:-120,INVALID_FILETYPE:-130};SWFUpload.UPLOAD_ERROR={HTTP_ERROR:-200,MISSING_UPLOAD_URL:-210,IO_ERROR:-220,SECURITY_ERROR:-230,UPLOAD_LIMIT_EXCEEDED:-240,UPLOAD_FAILED:-250,SPECIFIED_FILE_ID_NOT_FOUND:-260,FILE_VALIDATION_FAILED:-270,FILE_CANCELLED:-280,UPLOAD_STOPPED:-290};SWFUpload.FILE_STATUS={QUEUED:-1,IN_PROGRESS:-2,ERROR:-3,COMPLETE:-4,CANCELLED:-5};
SWFUpload.BUTTON_ACTION={SELECT_FILE:-100,SELECT_FILES:-110,START_UPLOAD:-120};SWFUpload.CURSOR={ARROW:-1,HAND:-2};SWFUpload.WINDOW_MODE={WINDOW:"window",TRANSPARENT:"transparent",OPAQUE:"opaque"};SWFUpload.completeURL=function(b){if(typeof b!=="string"||b.match(/^https?:\/\//i)||b.match(/^\//))return b;var c=window.location.pathname.lastIndexOf("/");path=c<=0?"/":window.location.pathname.substr(0,c)+"/";return path+b};a=SWFUpload.prototype;
a.initSettings=function(){this.ensureDefault=function(b,c){this.settings[b]=this.settings[b]==undefined?c:this.settings[b]};this.ensureDefault("upload_url","");this.ensureDefault("preserve_relative_urls",false);this.ensureDefault("file_post_name","Filedata");this.ensureDefault("post_params",{});this.ensureDefault("use_query_string",false);this.ensureDefault("requeue_on_error",false);this.ensureDefault("http_success",[]);this.ensureDefault("assume_success_timeout",0);this.ensureDefault("file_types",
...
undefined){alert("You have to specify the button id");return false}if($(this).size()==0){alert("The jQuery element is empty. Method pandaUploader() cannot be executed");return false}g=jQuery.extend({upload_filename_id:null,upload_progress_id:null,api_url:"http://api.pandastream.com/v2",progress_handler:null,uploader_dir:"/panda_uploader"},g);if(!g.progress_handler)g.progress_handler=new b(g);var j=this.swfupload(jQuery.extend({upload_url:g.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",
file_types_description:"All Files",file_upload_limit:0,flash_url:g.uploader_dir+"/swfupload.swf",button_image_url:g.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:g.upload_button_id,post_params:e,file_post_name:"file",debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(e){if(this.$p.size()!=
0){this.$p.find(".progress-inside").size()==0&&this.$p.append('<div class="progress-inside"></div>');this.progress=this.$p.find(".progress-inside");this.setProgress(e,0,e.size);this.$p.show()}},setProgress:function(e,g,h){if(this.progress){e=Math.ceil(g/h*100);$(this.progress).css("width",e+"%")}}}})();
var a,SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};SWFUpload.prototype.initSWFUpload=function(b){try{this.customSettings={};this.settings=b;this.eventQueue=[];this.movieName="SWFUpload_"+SWFUpload.movieCount++;this.movieElement=null;SWFUpload.instances[this.movieName]=this;this.initSettings();this.loadFlash();this.displayDebugInfo()}catch(c){delete SWFUpload.instances[this.movieName];throw c;}};SWFUpload.instances={};SWFUpload.movieCount=0;SWFUpload.version="2.2.0 2009-03-25";
SWFUpload.QUEUE_ERROR={QUEUE_LIMIT_EXCEEDED:-100,FILE_EXCEEDS_SIZE_LIMIT:-110,ZERO_BYTE_FILE:-120,INVALID_FILETYPE:-130};SWFUpload.UPLOAD_ERROR={HTTP_ERROR:-200,MISSING_UPLOAD_URL:-210,IO_ERROR:-220,SECURITY_ERROR:-230,UPLOAD_LIMIT_EXCEEDED:-240,UPLOAD_FAILED:-250,SPECIFIED_FILE_ID_NOT_FOUND:-260,FILE_VALIDATION_FAILED:-270,FILE_CANCELLED:-280,UPLOAD_STOPPED:-290};SWFUpload.FILE_STATUS={QUEUED:-1,IN_PROGRESS:-2,ERROR:-3,COMPLETE:-4,CANCELLED:-5};
SWFUpload.BUTTON_ACTION={SELECT_FILE:-100,SELECT_FILES:-110,START_UPLOAD:-120};SWFUpload.CURSOR={ARROW:-1,HAND:-2};SWFUpload.WINDOW_MODE={WINDOW:"window",TRANSPARENT:"transparent",OPAQUE:"opaque"};SWFUpload.completeURL=function(b){if(typeof b!=="string"||b.match(/^https?:\/\//i)||b.match(/^\//))return b;var c=window.location.pathname.lastIndexOf("/");path=c<=0?"/":window.location.pathname.substr(0,c)+"/";return path+b};a=SWFUpload.prototype;
a.initSettings=function(){this.ensureDefault=function(b,c){this.settings[b]=this.settings[b]==undefined?c:this.settings[b]};this.ensureDefault("upload_url","");this.ensureDefault("preserve_relative_urls",false);this.ensureDefault("file_post_name","Filedata");this.ensureDefault("post_params",{});this.ensureDefault("use_query_string",false);this.ensureDefault("requeue_on_error",false);this.ensureDefault("http_success",[]);this.ensureDefault("assume_success_timeout",0);this.ensureDefault("file_types",
...
c);b.merge(e,d);b.each(e,function(t,m){var r=m.replace(/_handler$/,"").replace(/_([a-z])/g,function(l,q){return q.toUpperCase()});g[m]=function(){var l=b.Event(r);h.trigger(l,b.makeArray(arguments));return!l.isDefaultPrevented()}});b(this).data("__swfu",new SWFUpload(g))}}else if(f.length>0&&typeof f[0]=="string"){var n=f.shift();(e=b(this).data("__swfu"))&&e[n]&&e[n].apply(e,f)}})};b.swfupload={additionalHandlers:function(){if(arguments.length===0)return d.slice();else b(arguments).each(function(f,
e){b.merge(d,b.makeArray(e))})},defaultHandlers:function(){return c.slice()},getInstance:function(f){return b(f).data("__swfu")}}})(jQuery);
(function(){function b(e){this.options=e;this.$p=jQuery("#"+this.options.upload_progress_id);this.$p.css("display","none")}var c=0,d=0,f=0;jQuery.fn.pandaUploader=function(e,g,h){function n(){o.closest("form").submit(m)}function t(i,k){c++;d++;i=$("#"+g.upload_filename_id);i.size()!=0&&i.val(k.name)}function m(){j.swfupload("startUpload");return false}function r(i,k){g.progress_handler&&g.progress_handler.start(k)}function l(i,k,p,s){try{g.progress_handler&&g.progress_handler.setProgress(k,p,s)}catch(w){}}
function q(i,k,p){o.val(eval("("+p+")").id);d--}function u(i,k,p,s){alert("There was an error uploading the file.\n\nHTTP error code "+s);d--;f++}function v(){if(!(d>0&&c!=f||c==f))if(o.val()){var i=o.closest("form")[0];document.createElement("FORM").submit.apply(i)}else alert("The video ID was not stored on the form")}if(e===undefined){alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}g=g===undefined?{}:g;h=h===undefined?{}:h;if(g.upload_button_id===
undefined){alert("You have to specify the button id");return false}if($(this).size()==0){alert("The jQuery element is empty. Method pandaUploader() cannot be executed");return false}g=jQuery.extend({upload_filename_id:null,upload_progress_id:null,api_url:"http://api.pandastream.com/v2",progress_handler:null,uploader_dir:"/panda_uploader"},g);if(!g.progress_handler)g.progress_handler=new b(g);var j=this.swfupload(jQuery.extend({upload_url:g.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",
file_types_description:"All Files",file_upload_limit:0,flash_url:g.uploader_dir+"/swfupload.swf",button_image_url:g.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:g.upload_button_id,post_params:e,file_post_name:"file",debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(e){if(this.$p.size()!=
0){this.$p.find(".progress-inside").size()==0&&this.$p.append('<div class="progress-inside"></div>');this.progress=this.$p.find(".progress-inside");this.setProgress(e,0,e.size);this.$p.css("display","block")}},setProgress:function(e,g,h){if(this.progress){e=Math.ceil(g/h*100);$(this.progress).css("width",e+"%")}}}})();
