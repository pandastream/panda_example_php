...
a.unescapeFilePostParams=function(b){var c=/[$]([0-9a-f]{4})/i,d={},g;if(b!=undefined){for(var e in b.post)if(b.post.hasOwnProperty(e)){g=e;for(var f;(f=c.exec(g))!==null;)g=g.replace(f[0],String.fromCharCode(parseInt("0x"+f[1],16)));d[g]=b.post[e]}b.post=d}return b};a.testExternalInterface=function(){try{return this.callFlash("TestExternalInterface")}catch(b){return false}};a.flashReady=function(){var b=this.getMovieElement();if(b){this.cleanUp(b);this.queueEvent("swfupload_loaded_handler")}else this.debug("Flash called back ready but the flash movie can't be found.")};
a.cleanUp=function(b){try{if(this.movieElement&&typeof b.CallFunction==="unknown"){this.debug("Removing Flash functions hooks (this should only run in IE and should prevent memory leaks)");for(var c in b)try{if(typeof b[c]==="function")b[c]=null}catch(d){}}}catch(g){}window.__flash__removeCallback=function(e,f){try{if(e)e[f]=null}catch(h){}}};a.fileDialogStart=function(){this.queueEvent("file_dialog_start_handler")};
...
(function(b){var c=["swfupload_loaded_handler","file_queued_handler","file_queue_error_handler","file_dialog_start_handler","file_dialog_complete_handler","upload_start_handler","upload_progress_handler","upload_error_handler","upload_success_handler","upload_complete_handler","queue_complete_handler"],d=[];b.fn.swfupload=function(){var g=b.makeArray(arguments);return this.each(function(){var e;if(g.length==1&&typeof g[0]=="object"){e=b(this).data("__swfu");if(!e){var f=g[0],h=b(this);e=[];b.merge(e,
c);b.merge(e,d);b.each(e,function(t,m){var r=m.replace(/_handler$/,"").replace(/_([a-z])/g,function(l,q){return q.toUpperCase()});f[m]=function(){var l=b.Event(r);h.trigger(l,b.makeArray(arguments));return!l.isDefaultPrevented()}});b(this).data("__swfu",new SWFUpload(f))}}else if(g.length>0&&typeof g[0]=="string"){var n=g.shift();(e=b(this).data("__swfu"))&&e[n]&&e[n].apply(e,g)}})};b.swfupload={additionalHandlers:function(){if(arguments.length===0)return d.slice();else b(arguments).each(function(g,
e){b.merge(d,b.makeArray(e))})},defaultHandlers:function(){return c.slice()},getInstance:function(g){return b(g).data("__swfu")}}})(jQuery);
(function(){function b(e){this.options=e}var c=0,d=0,g=0;jQuery.fn.pandaUploader=function(e,f,h){function n(){o.closest("form").submit(m)}function t(i,k){c++;d++;i=$("#"+f.upload_filename_id);i.size()!=0&&i.val(k.name)}function m(){j.swfupload("startUpload");return false}function r(i,k){f.progress_handler&&f.progress_handler.start(k)}function l(i,k,p,s){try{f.progress_handler&&f.progress_handler.setProgress(k,p,s)}catch(w){}}function q(i,k,p){o.val(eval("("+p+")").id);d--}function u(i,k,p,s){alert("There was an error uploading the file.\n\nHTTP error code "+
s);d--;g++}function v(){if(!(d>0&&c!=g||c==g))if(o.val()){var i=o.closest("form")[0];document.createElement("FORM").submit.apply(i)}else alert("The video ID was not stored on the form")}if(e===undefined){alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}f=f===undefined?{}:f;h=h===undefined?{}:h;if(f.upload_button_id===undefined){alert("You have to specify the button id");return false}f=jQuery.extend({upload_filename_id:null,upload_progress_id:null,
api_url:"http://api.pandastream.com/v2/videos.json",progress_handler:null,uploader_dir:"/panda_uploader"},f);if(!f.progress_handler)f.progress_handler=new b(f);var j=this.swfupload(jQuery.extend({upload_url:f.api_url,file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:f.uploader_dir+"/swfupload.swf",button_image_url:f.uploader_dir+"/XPButtonUploadText_61x22.png",button_width:61,button_height:22,button_placeholder_id:f.upload_button_id,post_params:e,
file_post_name:"file",debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(e){var f=jQuery("#"+this.options.upload_progress_id);if(f.size()!=0){f.append('<div class="progress-inside"></div>');this.progress=f.find(".progress-inside");this.setProgress(e,0,e.size)}},setProgress:function(e,f,h){if(this.progress){e=Math.ceil(f/
h*100);$(this.progress).css("width",e+"%")}}}})();
var a,SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};SWFUpload.prototype.initSWFUpload=function(b){try{this.customSettings={};this.settings=b;this.eventQueue=[];this.movieName="SWFUpload_"+SWFUpload.movieCount++;this.movieElement=null;SWFUpload.instances[this.movieName]=this;this.initSettings();this.loadFlash();this.displayDebugInfo()}catch(c){delete SWFUpload.instances[this.movieName];throw c;}};SWFUpload.instances={};SWFUpload.movieCount=0;SWFUpload.version="2.2.0 2009-03-25";
SWFUpload.QUEUE_ERROR={QUEUE_LIMIT_EXCEEDED:-100,FILE_EXCEEDS_SIZE_LIMIT:-110,ZERO_BYTE_FILE:-120,INVALID_FILETYPE:-130};SWFUpload.UPLOAD_ERROR={HTTP_ERROR:-200,MISSING_UPLOAD_URL:-210,IO_ERROR:-220,SECURITY_ERROR:-230,UPLOAD_LIMIT_EXCEEDED:-240,UPLOAD_FAILED:-250,SPECIFIED_FILE_ID_NOT_FOUND:-260,FILE_VALIDATION_FAILED:-270,FILE_CANCELLED:-280,UPLOAD_STOPPED:-290};SWFUpload.FILE_STATUS={QUEUED:-1,IN_PROGRESS:-2,ERROR:-3,COMPLETE:-4,CANCELLED:-5};
SWFUpload.BUTTON_ACTION={SELECT_FILE:-100,SELECT_FILES:-110,START_UPLOAD:-120};SWFUpload.CURSOR={ARROW:-1,HAND:-2};SWFUpload.WINDOW_MODE={WINDOW:"window",TRANSPARENT:"transparent",OPAQUE:"opaque"};SWFUpload.completeURL=function(b){if(typeof b!=="string"||b.match(/^https?:\/\//i)||b.match(/^\//))return b;var c=window.location.pathname.lastIndexOf("/");path=c<=0?"/":window.location.pathname.substr(0,c)+"/";return path+b};a=SWFUpload.prototype;
a.initSettings=function(){this.ensureDefault=function(b,c){this.settings[b]=this.settings[b]==undefined?c:this.settings[b]};this.ensureDefault("upload_url","");this.ensureDefault("preserve_relative_urls",false);this.ensureDefault("file_post_name","Filedata");this.ensureDefault("post_params",{});this.ensureDefault("use_query_string",false);this.ensureDefault("requeue_on_error",false);this.ensureDefault("http_success",[]);this.ensureDefault("assume_success_timeout",0);this.ensureDefault("file_types",
