...
api_url:"http://api.pandastream.com/v2/videos.json",progress_handler:null,uploader_dir:"/panda_uploader"},e);if(!e.progress_handler)e.progress_handler=new b(e);var j=this.swfupload(jQuery.extend({upload_url:e.api_url,file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:e.uploader_dir+"/swfupload.swf",button_image_url:e.uploader_dir+"/XPButtonUploadText_61x22.png",button_width:61,button_height:22,button_placeholder_id:e.upload_button_id,post_params:f,
file_post_name:"file",debug:false},h)),o=this;j.bind("swfuploadLoaded",n);j.bind("fileQueued",t);j.bind("uploadStart",r);j.bind("uploadProgress",l);j.bind("uploadSuccess",q);j.bind("uploadError",u);j.bind("uploadComplete",v);return j};b.prototype={start:function(f){var e=jQuery("#"+this.options.upload_progress_id);if(e.size()!=0){e.find(".progress-inside").size()==0&&e.append('<div class="progress-inside"></div>');this.progress=e.find(".progress-inside");this.setProgress(f,0,f.size)}},setProgress:function(f,
