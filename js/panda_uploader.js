...
PandaUploader.init = function(auth_params, custom_args, swfu_args) {
    if (auth_params === undefined) {
        alert("There was an error setting up the upload form. (The signature parameter was not specified).");
        return false;
    }
    ...
    var api_url = 'http://' + custom_options.api_host + '/v' + custom_options.api_version;
